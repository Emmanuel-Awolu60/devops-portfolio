      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-center md:text-left">
          {/* <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 mb-6">
            ...
            <span className="text-sm font-medium text-slate-600 dark:text-slate-300">Available for Hire</span>
          </div> */}
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 mb-4 max-w-2xl mx-auto md:mx-0 leading-relaxed">
            I bridge the gap between development and operations. Building reliable, scalable, and secure cloud infrastructure is my craft.
          </p>
          
          <p className="text-base text-slate-500 dark:text-slate-400 mb-8 font-medium flex items-center justify-center md:justify-start gap-2">
            <Code2 className="w-4 h-4" />
            <span>Software Development Background</span>
        ...
        <div className="flex-1 w-full max-w-lg md:max-w-none relative">
            <div className="relative rounded-xl overflow-hidden shadow-2xl bg-slate-800 border border-slate-700">
                ...
                <div className="p-6 font-mono text-sm leading-6">
                    ...
                    <div className="text-slate-300 mt-2">Initializing the backend...</div>
                    <div className="text-green-400 mt-2">Successfully configured the backend "s3"!</div>
                    <div className="text-slate-400 mt-4"># Applying Infrastructure Plan</div>
                    <div className="text-green-400">$ terraform apply -auto-approve</div>
                    <div className="text-blue-400 mt-2">module.k8s_cluster.aws_eks_cluster.main: Creating...</div>
                    <div className="text-blue-400">module.vpc.aws_vpc.main: Creation complete after 3s [id=vpc-0a1b2c3d]</div>
                    <div className="text-green-400 mt-4">Apply complete! Resources: 12 added, 0 changed, 0 destroyed.</div>
