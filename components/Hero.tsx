...
const Hero: React.FC = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center pt-32 sm:pt-24 md:pt-20 overflow-hidden"
    >
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Flex only on md+ (fixes mobile width issues) */}
        <div className="flex flex-col md:flex-row items-center gap-12">
          {/* LEFT TEXT SECTION */}
          <div className="w-full md:flex-1 max-w-xl mx-auto md:mx-0 text-center md:text-left">
            ...
            {/* Buttons – reduced width on mobile */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <a
                href="#projects"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 md:text-lg transition-all hover:shadow-lg hover:shadow-blue-500/20"
              >
                View Projects
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 border border-slate-300 dark:border-slate-700 text-base font-medium rounded-md text-slate-700 dark:text-slate-200 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800 md:text-lg transition-all"
              >
                Contact Me
              </a>
            </div>
          ...
          {/* RIGHT CODE SECTION */}
          <div className="w-full md:flex-1 max-w-md mx-auto md:max-w-none relative">
